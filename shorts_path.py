...
gallery_path = 'shorts_gallery/'

bg_images_path = gallery_path + 'bg_images/'
bg_videos_path = gallery_path + 'bg_videos/'
...
data_file = 'data/shorts_data.xlsx'
completed_data_file = 'data\\shorts_completed_data.xlsx'
quote_file = 'data/shorts_quotations.xlsx'
